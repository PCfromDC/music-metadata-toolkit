"""Embed folder.ai.png into 70's Disco Ball Party Pack album"""
import shutil
...
cover_path = album_path / "folder.ai.png"
...
# Update folder.jpg (copy PNG to JPG - most players handle this)
