"""Embed cover art into Drop Leaf Rhythm album"""
import shutil
from pathlib import Path
from mutagen.mp3 import MP3
from mutagen.id3 import APIC

album_path = Path(r"/path/to/music/Various Artists/Drop Leaf Rhythm")
cover_path = Path(r"D:\music cleanup\temp_dropleaf_cover.jpg")
...
print(f"Created folder.jpg ({len(cover_data):,} bytes)")
